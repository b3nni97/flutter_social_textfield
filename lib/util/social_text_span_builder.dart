...
class SocialTextSpanBuilder {
  ...
  TextSpan build(String text,
    ...
    if (allMatches.isEmpty) {
      return textSpanBuilder?.call(text: text, style: defaultTextStyle) ??
          TextSpan(text: text, style: defaultTextStyle);
    }
    ...
    TextSpan root = textSpanBuilder?.call() ?? TextSpan();
  ...
  TextSpan getTextSpan(TextSpan? root, String text, TextStyle style,
    ...
    if (root == null) {
      return textSpanBuilder?.call(
              text: text, style: style, recognizer: tapRecognizer) ??
          TextSpan(text: text, style: style, recognizer: tapRecognizer);
    } else {
      return TextSpan(children: [
        root,
        textSpanBuilder?.call(
                text: text, style: style, recognizer: tapRecognizer) ??
            TextSpan(text: text, style: style, recognizer: tapRecognizer)
      ]);
    }
